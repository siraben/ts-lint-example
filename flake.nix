...
{
  description = "Linter based on tree-sitter";
    ...
    utils.lib.eachDefaultSystem
      (system:
        let
          ...
          buildInputs = with pkgs; [ openssl.dev ] ++ lib.optional stdenv.isDarwin (with darwin.apple_sdk.frameworks; [ Security Foundation CoreFoundation ]);
